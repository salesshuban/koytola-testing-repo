...
def get_currency_for_stripe(currency):
    """Convert Koytola's currency format to Stripe's currency format.

    Stripe's currency is using lowercase while Koytola is using uppercase.
    """
    return currency.lower()


def get_currency_from_stripe(currency):
    """Convert Stripe's currency format to Koytola's currency format.

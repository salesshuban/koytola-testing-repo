...
from .sorters import (
    ...
    SuccessStorySortingInput, 
    SocialResponsibilitySortingInput, 
    TradeShowsInput,
    IndexSortingInput
)
from .types import (
...
class ProfileQueries(graphene.ObjectType):
    ...
    brochures = FilterInputConnectionField(
        ...
        sort_by=IndexSortingInput(description="Sort images."),
    ...
    def resolve_company_rosetters(self, info, **kwargs):
        # from ...core.utils.random_data import create_rosetter
        # create_rosetter()
...
class ProfileMutations(graphene.ObjectType):
    ...
    success_story_bulk_delete = SuccessStoryBulkDelete.Field()
    trade_show_create = TradeShowCreate.Field()
    rosetter_create = RosetterCreate.Field()
    rosetter_update = RosetterUpdate.Field()
    rosetter_delete = RosetterDelete.Field()
    rosetter_bulk_delete = RosetterBulkDelete.Field()
    image_index_update = ImageIndexUpdate.Field()
    brochure_index_update = BrochureIndexUpdate.Field()
    video_index_update = VideoIndexUpdate.Field()
